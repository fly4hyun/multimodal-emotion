...
model_name = "Multi_Modal_TransformerEncoder2"
model = custom_model.Multi_Modal_TransformerEncoder2(num_classes, device)
...
sample_num = [2739, 438, 
              9895, 402, 667, 7391, 
              871, 17, 1766, 3010, 
              1781, 47, 2269, 92, 104, 139, 2153, 324, 351, 1975, 548, 232, 
              1970, 313, 2373, 80, 931, 969, 21, 109, 
              2415, 
              6492, 173, 133]
...
for epoch in range(epochs):
    ...
    for train_data in iterations:
        ...
        train_te_feature = train_data['te'].to(device)
        ...
        train_output = model(train_ie_feature, train_se_feature, train_te_feature)
    ...
    with torch.no_grad():
        ...
        for valid_data in iterations:
            ...
            valid_te_feature = valid_data['te'].to(device)
            ...
            valid_output = model(valid_ie_feature, valid_se_feature, valid_te_feature)
    ...
    with torch.no_grad():
        ...
        for test_data in iterations:
            ...
            test_te_feature = test_data['te'].to(device)
            ...
            test_output = model(test_ie_feature, test_se_feature, test_te_feature)
    ...
    if valid_loss < best_valid_loss:
        ...
        model_path = './models_34/' + model_name + '_top' + str(k_top) + '.pth'
        model = model.cpu()
