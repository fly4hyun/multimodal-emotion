...
model = custom_model_te_ie.Multi_Modal_MFB(num_classes, device)
...
for epoch in range(epochs):
    ...
    for train_data in iterations:
        ...
        train_output = model(train_te_feature, train_ie_feature)
    ...
    with torch.no_grad():
        ...
        for valid_data in iterations:
            ...
            valid_output = model(valid_te_feature, valid_ie_feature)
    ...
    with torch.no_grad():
        ...
        for test_data in iterations:
            ...
            test_output = model(test_te_feature, test_ie_feature)
    ...
    if valid_loss < best_valid_loss:
        ...
        model_path = './models_34_te_ie/' + model_name + '_top' + str(k_top) + '.pth'
        model = model.cpu()
