...
model_name = "Multi_Modal_FC"
model = custom_model_se.Multi_Modal_FC(num_classes, device)
...
for epoch in range(epochs):
    ...
    for train_data in iterations:
        ...
        train_output = model(train_se_feature)
    ...
    with torch.no_grad():
        ...
        for valid_data in iterations:
            ...
            valid_output = model(valid_se_feature)
    ...
    with torch.no_grad():
        ...
        for test_data in iterations:
            ...
            test_output = model(test_se_feature)
    ...
    if valid_loss < best_valid_loss:
        ...
        model_path = './models_34_se/' + model_name + '_top' + str(k_top) + '.pth'
        model = model.cpu()
