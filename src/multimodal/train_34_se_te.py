...
model = custom_model_se_te.Multi_Modal_MFB(num_classes, device)
...
for epoch in range(epochs):
    ...
    for train_data in iterations:
        ...
        train_output = model(train_se_feature, train_te_feature)
    ...
    with torch.no_grad():
        ...
        for valid_data in iterations:
            ...
            valid_output = model(valid_se_feature, valid_te_feature)
    ...
    with torch.no_grad():
        ...
        for test_data in iterations:
            ...
            test_output = model(test_se_feature, test_te_feature)
    ...
    if valid_loss < best_valid_loss:
        ...
        model_path = './models_34_se_te/' + model_name + '_top' + str(k_top) + '.pth'
        model = model.cpu()
